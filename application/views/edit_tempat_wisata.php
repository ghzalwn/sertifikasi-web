              ...
              <form method="POST" action="<?php echo base_url('home/submit_tempat_wisata')?>">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" placeholder="" name="id" value="<?php echo $data['id']?>">
                    <input type="text" class="form-control" placeholder="" name="nama_tempat"  value="<?php echo $data['nama_tempat']?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Price</label>
                    <input type="number" class="form-control" placeholder="Price" name="price" value="<?php echo $data['price']?>">
                  </div>
                  <div class="form-group">
